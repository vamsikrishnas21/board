...
class Whiteboard extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.socket.on("collabdata", (data) => {
            var image = new Image();
    ...
    drawOnBoard() {
        ...
        document.addEventListener("keydown", (e) => {
            ...
            if (e.keyCode === 8) {
                del();
                var previousChar = previousChars[previousChars.length - 1];
                ...
                currentState();
                previousChars.push(e.key);
            }
            var base64ImageData = collabcanvas.toDataURL("image/png");
            this.socket.emit("collabdata", base64ImageData);
        }, false);
